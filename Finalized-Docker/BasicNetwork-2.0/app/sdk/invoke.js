    ...
    //     // 5. Get the contract
     const contract = await network.getContract(CONTRACT_ID);
        ...
        if (fcn === "transfer") {
            ...
            console.log(String(fcn), String(args[0]),String(args[1]),String(args[2]),String(args[3]),String(args[4]),String(args[5]));
            result = await contract.submitTransaction(String(fcn), String(args[0]),String(args[1]),String(args[2]),String(args[3]),String(args[4]),String(args[5]));
            // message = `Successfully added the car asset with key ${args[0]}`;
            console.log(String(result));
